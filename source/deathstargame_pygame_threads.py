...
class App:
    ...
    def on_loop(self):
        ...
        pygame.draw.rect(self._display_surf, grey, (self.actx-self.actplateradius*.4,self.acty,self.actplateradius*0.8,self.actplateradius*3.0), 0)
        pygame.draw.rect(self._display_surf, grey, (self.actx-self.actplateradius*.4,self.acty+self.actplateradius*1.5,self.actplateradius*0.8,self.actplateradius*3.0), 0)
